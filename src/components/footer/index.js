...
const Footer = ({ location }) => {
  ...
  return (
    <Container>
      ...
      <List>
        <a
          href="https://www.github.com/cristianve/"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/cristianve/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <ListItem>
        ...
        <a href="mailto:97cvega@gmail.com" rel="noopener noreferrer">
          <ListItem>
            <Icon>
              <AiOutlineMail />
            </Icon>
      ...
      <Typography textAlign="center" color="#ffffff">
        Handcrafted by @cristianve - © {currentYear}
      </Typography>
