...
const LandingPage = ({ location: { pathname } }) => (
  <Layout location={pathname}>
    <SEO
      title="Cristian V | Software Engineer Developer"
      description="Personal Engineer Developer Portfolio. I'm a Fullstack developer with emphasis on Back-End and Java specialist"
    />
    <Container>
      <Wrapper>
        <TitleWrapper>
    ...
    <CenteredContainer variantBackground>
      <CenteredWrapper>
        <Title color="white" fontSize="2rem" fontWeight={700}>
          Hi, I&apos;m Cristian. Pleasure to meet you.
        </Title>
        <Typography color="white" textAlign="center">
          Coming from Mollet, Barcelona, I started my journey as a
          developer in 2016 but when I was 10-11 years old, I made a video game server with a neighbor and there it all began. I have special interest in back-end , where I have worked most of my projects and potentialized
